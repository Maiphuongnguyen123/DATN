...
import Nav from './Nav';
import { disableRoom, getAllRoomOflandlord } from '../../services/fetch/ApiUtils';
...
function RoomManagement(props) {
    ...
    const fetchData = () => {
        getAllRoomOflandlord(currentPage, itemsPerPage, searchQuery).then(response => {
    ...
    const handleRedirectAddRoom = () => {
        history('/landlord/add-room')
    }

    const handleEditRoom = (id) => {
        history('/landlord/edit-room/' + id)
    }
