...
import Nav from './Nav';
import { deleteMaintenance, getAllMaintenceOflandlord } from '../../services/fetch/ApiUtils';
...
function MaintenceManagement(props) {
    ...
    const fetchData = () => {
        getAllMaintenceOflandlord(currentPage, itemsPerPage, searchQuery).then(response => {
    ...
    const handleRedirectAddMaintenance = () => {
        history('/landlord/add-maintenance')
    }

    const handleEditMaintenance = (id) => {
        history('/landlord/edit-maintenance/' + id)
    }
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            <div id="datatables-buttons_wrapper" className="dataTables_wrapper dt-bootstrap5 no-footer"><div className="row"><div className="col-sm-12 col-md-6"><div className="dt-buttons btn-group flex-wrap">
                                <button className="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="datatables-buttons" type="button">
                                    <a onClick={handleRedirectAddMaintenance}>Thêm Phiếu Bảo Trì</a>
                                </button>
                            </div></div>
