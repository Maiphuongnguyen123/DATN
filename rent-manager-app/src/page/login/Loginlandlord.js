            ...
            <div className="login-container">
                ...
                <div className="login-popup">
                    <div className="mb-4 text-center">
                        ...
                        <p className="mb-4">Nếu bạn chưa có tài khoản. <a href="/signup-landlord">Đăng ký tài khoản mới</a> để bắt đầu cho thuê các phòng trọ của mình</p>
                    </div>
                    <LoginForm />
