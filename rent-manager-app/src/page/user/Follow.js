                ...
                <div className="wrapper">
                    ...
                    <div className="main">
                        ...
                        <div className="card">
                            ...
                            {tableData.map((item) => (
                                item.landlord ? (
                                        <div className="col-md-4" key={item.landlord.id}>
                                            <div className="card-box-d">
                                                <div className="card-img-d">
                                                    {item.landlord?.imageUrl ?
                                                        <img src={item.landlord.imageUrl} alt="" className="img-d img-fluid" style={{ height: "392px" }} />
                                                        :
                                                ...
                                                <div className="card-overlay card-overlay-hover">
                                                    <div className="card-header-d">
                                                        <div className="card-title-d align-self-center">
                                                            <h3 className="title-d">
                                                                <Link to={`/angent-single/${item.landlord.id}`} className="link-two">{item.landlord.name}</Link>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                    <div className="card-body-d">
                                                        ...
                                                        <div className="info-agents color-a">
                                                            <p style={{color : "white"}}>
                                                                <strong>Phone: </strong> {item.landlord.phone}
                                                            </p>
                                                            <p style={{color : "white"}}>
                                                                <strong>Email: </strong> {item.landlord.email}
                                                            </p>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div className="socials-footer d-flex justify-content-center">
                                                            <ul className="list-inline">
                                                                <li className="list-inline-item">
                                                                    <a href={item.landlord?.zaloUrl} className="link-one" target="_blank" rel="noopener noreferrer">
                                                                        <i className="bi bi-facebook" aria-hidden="true"></i>
                                                                    </a>
                                                                </li>
                                                                <li className="list-inline-item">
                                                                    <a href={item.landlord?.facebookUrl} className="link-one" target="_blank" rel="noopener noreferrer">
