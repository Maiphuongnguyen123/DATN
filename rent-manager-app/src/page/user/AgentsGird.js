                                                ...
                                                <div className="card-overlay card-overlay-hover">
                                                    <div className="card-header-d">
                                                        <div className="card-title-d align-self-center">
                                                            <h3 className="title-d">
                                                                <Link to={`/angent-single/`+landlord.id} className="link-two">{landlord.name}</Link>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                    <div className="card-body-d">
                                                        ...
                                                        <div className="info-agents color-a">
                                                            <p style={{color : "white"}}>
                                                                <strong>Phone: </strong> {landlord.phone}
                                                            </p>
                                                            <p style={{color : "white"}}>
                                                    ...
                                                    <div className="card-footer-d">
                                                        <div className="socials-footer d-flex justify-content-center">
                                                            ...
                                                            {landlord?.facebookUrl  ?                                                                 <li className="list-inline-item">
                                                                    <a href={landlord?.facebookUrl} className="link-one" target="_blank">
                                                                        <i className="bi bi-facebook" aria-hidden="true"></i>
                                                                    </a>
                                                                </li> : <></>}
                                                                {landlord?.zaloUrl?                                                                 <li className="list-inline-item">
