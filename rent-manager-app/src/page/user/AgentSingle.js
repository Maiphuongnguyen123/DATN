...
import { followAgents, getAccountById, getAllAccountlandlordForCustomer, getAllrRoomByUserId } from "../../services/fetch/ApiUtils";
...
const AgentSingle = (props) => {
    ...
    const handleFollowAgents = () => {
        const followRequest = {landlordId : id};
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-8">
                                <div class="title-single-box">
                                    <h1 class="title-single">{landlord?.name}</h1>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="agent-avatar-box">
                                            {landlord?.imageUrl ?
                                                <img src={landlord?.imageUrl} alt="" className="img-d img-fluid" style={{ height: "392px" }} />
                                                :
                                        ...
                                        <div class="agent-info-box">
                                            <div class="agent-title">
                                                <div class="title-box-d">
                                                    <h3 class="title-d"> {landlord?.name}
                                                    </h3>
                                                </div>
                                            </div>
                                            <div class="agent-content mb-3">
                                                ...
                                                <div class="info-agents color-a">
                                                    <p>
                                                        ...
                                                        <span class="color-text-a">{landlord?.phone}</span>
                                                    </p>
                                                    <p>
                                                        <strong>Email: </strong>
                                                        <span class="color-text-a">{landlord?.email}</span>
                                                    </p>
                                                </div>
                                                <br></br>
                                            ...
                                            <div class="socials-footer">
                                                <ul class="list-inline">
                                                    <li className="list-inline-item">
                                                        <a href={landlord?.zaloUrl} className="link-one" target="_blank">
                                                            <i className="bi bi-facebook" aria-hidden="true"></i>
                                                        </a>
                                                    </li>
                                                    <li className="list-inline-item">
                                                        <a href={landlord?.facebookUrl} className="link-one" target="_blank">
